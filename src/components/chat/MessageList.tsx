...
/** Compact one-line chip for a `RoleState` tool call. The full character board
 * is rendered separately in the right-panel "role state" tab. */
function RoleStateChip({
  block,
}: {
