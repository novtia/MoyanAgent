...
use super::super::common::{
    ...
    find_sse_event_end, is_empty_stream_upstream_error, is_json_response, merge_tool_call_deltas,
    merge_usage, post_with_retries, should_retry_failed_stream_attempt, should_retry_http_error,
