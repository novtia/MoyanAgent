...
LangString customWelcomeTitle ${LANG_SIMPCHINESE} "欢迎"
LangString customWelcomeSubtitle ${LANG_SIMPCHINESE} "安装 ${PRODUCTNAME}"
LangString customWelcomeHeading ${LANG_SIMPCHINESE} "欢迎使用 Atelier"
LangString customWelcomeVersion ${LANG_SIMPCHINESE} "版本"
LangString customWelcomeBody ${LANG_SIMPCHINESE} "Atelier 是一款本地 AI 图像生成工作室，支持多模型与多供应商接入。$\n$\n安装过程会自动检测并配置 WebView2 运行时。"
LangString customWelcomeHint ${LANG_SIMPCHINESE} "点击「下一步」继续安装向导。"
LangString customInfoTitle ${LANG_SIMPCHINESE} "安装须知"
LangString customInfoSubtitle ${LANG_SIMPCHINESE} "继续前请确认以下信息"
LangString customInfoBody ${LANG_SIMPCHINESE} "本安装程序将把 ${PRODUCTNAME} 安装到您选择的目录，并在开始菜单创建快捷方式。"
LangString customInfoFeature1 ${LANG_SIMPCHINESE} "• 本地运行，数据保存在本机"
LangString customInfoFeature2 ${LANG_SIMPCHINESE} "• 支持 OpenAI、Gemini 等多供应商模型"
LangString customInfoFeature3 ${LANG_SIMPCHINESE} "• 基于 Tauri 2 构建，轻量高效"
LangString customInfoWebView2 ${LANG_SIMPCHINESE} "若系统未安装 WebView2，安装程序将自动下载并安装。"
LangString customFinishTitle ${LANG_SIMPCHINESE} "安装完成"
LangString customFinishText ${LANG_SIMPCHINESE} "${PRODUCTNAME} 已成功安装到您的计算机。$\n$\n您可以立即启动应用，或点击「完成」退出安装向导。"
